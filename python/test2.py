...
while True:
    ...
    T12 = Rz(theta1) @ Tz(d1)       @ Tx(a1)    @ Rx(0)      @ Ry(-75)
    T23 = Rz(theta2) @ Tz(0)        @ Tx(a2)    @ Rx(0)      @ Ry(128) @ Rz(theta3)
    T34 = Rz(0)      @ Tz(-d3)      @ Tx(0)     @ Rx(0)
    T45 = Rz(theta4) @ Tz(-d4)      @ Tx(0)     @ Rx(alpha5)
    T56 = Rz(theta5) @ Tz(0)        @ Tx(a5)    @ Rx(alpha6)
    T6E = Rz(theta6) @ Tz(0)        @ Tx(a6)    @ Rx(0)
    ...
    ax.quiver(T06[0, 3], T06[1, 3], T06[2, 3], X6[0, 0], X6[1, 0], X6[2, 0], color='r', length=35)
    ax.quiver(T06[0, 3], T06[1, 3], T06[2, 3], Y6[0, 0], Y6[1, 0], Y6[2, 0], color='g', length=35)
    ax.quiver(T06[0, 3], T06[1, 3], T06[2, 3], Z6[0, 0], Z6[1, 0], Z6[2, 0], color='b', length=35) 
